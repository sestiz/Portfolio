...
<body>
     <div id="conteneur">
        ...
        <div id="contenu">
         <p>22.	Avez-vous des suggestions de thèmes, de conférenciers et d'exposants pour le prochain Congrès ?</p>
         <form action="" method="post" name="myForm" id="sondage_form">
         	<textarea id="commentaire" name="sondage" resize="none" placeholder="Entrez votre commentaire ici"></textarea>
            <?php
	 			echo $liens;
	 		?>
         </form>
